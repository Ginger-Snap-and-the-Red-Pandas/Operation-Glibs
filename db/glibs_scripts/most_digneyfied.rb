...
scene_one_dialogue = " I'm sure many of you are *word why I gathered you here today. As many of you know, we recently encountered *caption. What you don't know is that *title. Not only that, *word is my *word friend."
...
s1_glib_word_types = [ "verb", "singular noun", "adjective" ]
#  ex:  s#_glib_word_types = ["singular noun", "singular noun", "adjective", "plural noun", "verb", "adjective"]
################
################
###Scene Two Dialogue (Write it inside the quotation marks):
scene_two_dialogue = " The first day I encountered *title was also the day I first saw *caption. My *word were mixed, to say the least. But *word showed me a better path. A digneyfied path."
...
#Write your glib-word-tyoes in the array below (e.g. "noun", "verb", or "adjective")
s2_glib_word_types = [ "plural noun", "singular noun" ]
#  ex:  s#_glib_word_types = ["singular noun", "singular noun", "adjective", "plural noun", "verb", "adjective"]
################
################
###Scene Three Dialogue (Write it inside the quotation marks):
scene_three_dialogue = " Now I rejoice whenever I see *caption. All because of my *word friend. *word, thank you."
