...
WordBlank.create(scene: @scene_one, position: 1, word_type: noun)
WordBlank.create(scene: @scene_one, position: 2, word_type: verb)
WordBlank.create(scene: @scene_one, position: 3, word_type: noun)
WordBlank.create(scene: @scene_one, position: 4, word_type: noun)
WordBlank.create(scene: @scene_one, position: 5, word_type: noun)
